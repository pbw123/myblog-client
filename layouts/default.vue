  ...
  <div id="app" :class="[!night?one:two]"
    ...
    <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
      ...
      <van-popup v-model="show" position="left" class="nav-mobile"
                 :style="{backgroundImage: 'url(' + (night ? info.wBar : info.wBar2) + ')',backgroundSize:'100% 100%'}">
        <div class="">
          <div class="one" @click="goHome()">
            <div class="icon">
              <img :src="home" alt="">
            </div>
            <nuxt-link to="" class="item">首页</nuxt-link>
          </div>
          <div class="one" @click="goDynamic()">
            <div class="icon">
              <img :src="dynamic" alt="">
            </div>
            <nuxt-link to="" class="item">动态</nuxt-link>
          </div>
          <div class="one" @click="goMessage()">
            <div class="icon">
              <img :src="message" alt="">
            </div>
            <nuxt-link to="" class="item">留言</nuxt-link>
          </div>
          <div class="one" @click="goAbout()">
            <div class="icon">
              <img :src="about" alt="">
            </div>
            <nuxt-link to="" class="item">关于</nuxt-link>
          </div>
    ...
    export default {
        ...
        methods: {
            ...
            async fetchSomething() {
                ...
                const contact = await this.$axios.$get('http://localhost:8888/attention/getMyContact')
                this.con = contact.data
