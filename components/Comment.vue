      ...
      <div class="comment">
        ...
        <div class="header">
          <div class="user-msg" @click="getMyInfo">
            <img v-show="have" :src="icon" class="avatar">
            <img v-show="!have"
                 :src="logo"
                 class="avatar">
          </div>
        ...
        <el-drawer @closed="clear"
          ...
          <Login :class="[isVisible?look:'']" @func="getMsgFormSon" @reset="drawer =false" @goRegister="goRegister"
                 ...
                 :imageUrl="icon" @icon="getUserIcon" @killIcon="rmIcon" ref="login"
                  ...
                  <div class="child-reply">
                    ...
                    <div class="child-btn">
                      ...
                      <div v-show="item.aId!==undefined&myinfo.userId===re.userId" class="child-del">
                        <span @click="del(4,re.id)" class="black del">删除</span>
                      </div>
                      <!-- 留言子删除-->
                      <div v-show="item.aId===undefined&myinfo.userId===re.userId" class="child-del">
                        <span @click="del(2,re.id)" class="black del">删除</span>
                      </div>
                      <!--   文章评论子回复 -->
...
import icon from '../assets/imgs/a2.jpg'
import icon1 from '../assets/imgs/a1.jpg'
  ...
  methods: {
    ...
    subCom() {
      ...
      if (user === null) {
        ...
        ax({
          method: 'post',
          url: 'http://localhost:8888/comment/addCom',
          data: {
            content: content,
            userId: user.userId,
            articleId: _that.aId
